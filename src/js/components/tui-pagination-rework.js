...
(function webpackUniversalModuleDefinition(root, factory) {
  ...
  else if (typeof exports === 'object') exports['Pagination'] = factory();
  else
        ...
        var View = defineClass(
          /** @lends View.prototype */ {
            ...
            _appendFirstButton: function (viewData) {
              ...
              button.firstChild.textContent = '1';
              button.firstChild.hidden = true;
              if (viewData.page > 3) {
                button.firstChild.hidden = false;
              }
              if (viewData.rightPageNumber < 6) {
                button.firstChild.hidden = true;
